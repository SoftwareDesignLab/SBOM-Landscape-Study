...
abs_s1c1="$(pwd)/scenario1/case1a/out"
abs_s1c2="$(pwd)/scenario1/case2a/out"
abs_s1c3="$(pwd)/scenario1/case3a/out"
...
docker build -t plugfest:mvn -f docker/with_maven/plugfest-mvn.Dockerfile .

# Build tool images
echo "Building Tool Images: This may take a while"
echo "Building Scenario 1; Case 1"
docker build --build-arg project_path=$s1c1 -t cdxgen:s1c1 -f docker/with_maven/cdxgen.Dockerfile .
docker build --build-arg project_path=$s1c1 -t ort:s1c1 -f docker/with_maven/ort.Dockerfile .
docker build --build-arg project_path=$s1c1 -t spdxgen:s1c1 -f docker/with_maven/spdxgen.Dockerfile .
docker build --build-arg project_path=$s1c1 -t syft:s1c1 -f docker/with_maven/syft.Dockerfile .
docker build --build-arg project_path=$s1c1 -t trivy:s1c1 -f docker/with_maven/trivy.Dockerfile .

echo "Building Scenario 1; Case 2"
docker build --build-arg project_path=$s1c2 -t cdxgen:s1c2 -f docker/with_maven/cdxgen.Dockerfile .
docker build --build-arg project_path=$s1c2 -t ort:s1c2 -f docker/with_maven/ort.Dockerfile .
docker build --build-arg project_path=$s1c2 -t spdxgen:s1c2 -f docker/with_maven/spdxgen.Dockerfile .
docker build --build-arg project_path=$s1c2 -t syft:s1c2 -f docker/with_maven/syft.Dockerfile .
docker build --build-arg project_path=$s1c2 -t trivy:s1c2 -f docker/with_maven/trivy.Dockerfile .

echo "Building Scenario 1; Case 3"
docker build --build-arg project_path=$s1c3 -t cdxgen:s1c3 -f docker/with_maven/cdxgen.Dockerfile .
docker build --build-arg project_path=$s1c3 -t ort:s1c3 -f docker/with_maven/ort.Dockerfile .
docker build --build-arg project_path=$s1c3 -t spdxgen:s1c3 -f docker/with_maven/spdxgen.Dockerfile .
docker build --build-arg project_path=$s1c3 -t syft:s1c3 -f docker/with_maven/syft.Dockerfile .
docker build --build-arg project_path=$s1c3 -t trivy:s1c3 -f docker/with_maven/trivy.Dockerfile .
